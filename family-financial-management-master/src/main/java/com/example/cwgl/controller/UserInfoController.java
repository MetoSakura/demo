...
//    @RequestMapping(value = "/login.do",method = RequestMethod.POST)
    ...
    public @ResponseBody Result updateUserPassword(UserInfo userInfo,@RequestParam(name = "newPassword") String newPassword,@RequestParam(name = "reNewPassword") String  reNewPassword, HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            int num = userInfoService.changePassword(userInfo,newPassword);
            if(num>0){
